...
class AqiData:
    ...
    def aqi_level(aqi_value):
        if aqi_value < 0:
            raise ValueError('AQI value must not be minus.')
        elif aqi_value < 50:
            return u'好'
        elif aqi_value < 100:
            return u'普通'
    ...
    def co(self):
        ...
        Returns:
            AQI in integer.
        """
        return int(self._data.get('iaqi', {}).get('co', {}).get('v', AqiData.UNKNOWN_INT))
    ...
    def no2(self):
        ...
        Returns:
            AQI in integer.
        """
        return int(self._data.get('iaqi', {}).get('no2', {}).get('v', AqiData.UNKNOWN_INT))
